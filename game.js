...
function hitBomb (player, bomb)
{
    ...
    gameOverText = this.add.text(200, 300, 'Game Over', { fontSize: '64px', fill: '#ffff' });
...
//audio fuctions
function CollectFX() {
    var audio = new Audio('assets/fx1.wav');
    audio.play();
  }

function bgSound() {
    var audio = new Audio('assets/bg1.mp3');
    audio.play();
  }